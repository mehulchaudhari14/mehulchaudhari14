...
class CarRentalSystem {
    ...
    public void returnCar(Car car) {
        if (car != null && !car.isAvailable()) {
            ...
            System.out.println("Car is not rented or is already available.");
        }
    }
    ...
    public void searchCars(String brand, String model, Double minPrice, Double maxPrice) {
        List<Car> filteredCars = cars.stream()
                .filter(car -> car.isAvailable() && // Add this filter to ensure the car is available
...
public class Main {
    public static void main(String[] args) {
        ...
        Car car1 = new Car("C001", "Toyota", "Corolla", 50.0);
        Car car2 = new Car("C002", "Honda", "Corolla", 55.0);
        Car car3 = new Car("C003", "Ford", "Corolla", 60.0);
        Car car4 = new Car("C004", "Chevrolet", "Corolla", 65.0);
        Car car5 = new Car("C005", "BMW", "X3", 120.0);
        Car car6 = new Car("C006", "Audi", "Q5", 130.0);
        Car car7 = new Car("C007", "Mercedes", "GLC", 140.0);
        Car car8 = new Car("C008", "Volkswagen", "Passat", 80.0);
        Car car9 = new Car("C009", "Nissan", "Altima", 70.0);
        Car car10 = new Car("C010", "Mazda", "CX-5", 90.0);
